                ...
                <div className="col1">
                  <div className="mt-4">
                    ...
                    <Form.Group
                      ...
                      controlId="exampleForm.ControlTextarea1"
                    >
                      <Form.Label>Upload cast picture</Form.Label>
                      <Form.Control type="file" />
                      <Form.Control.Feedback type="invalid">
                        Please upload a valid file.
                      </Form.Control.Feedback>
              ...
              <Form noValidate className="mt-5 add-cast-container w-50">
                ...
                <div className="col1">
                  <div>
                    ...
                    <div className="cast-section d-flex flex-column gap-3">
                      {casts.map((cast) => {
                        return (
                          <div className="d-flex align-items-center a-cast">
                            <img src={cast.image_url} alt="" width="100" />
                            <p className="m-0 ms-4 text-white">{cast.name}</p>
                          </div>
                        );
                      })}
                    </div>
